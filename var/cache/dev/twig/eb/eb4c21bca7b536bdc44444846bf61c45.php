...
class __TwigTemplate_44bc1ce221019d694352aae9feda2445 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo " MGA</p>
            <a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add_to_cart", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
        echo "\" class=\"btn btn-outline-primary\"> Ajouter au panier </a>
        </div>
    </div>
...
";
    ...
    {
        return array (  113 => 15,  109 => 14,  104 => 12,  100 => 11,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    <div class=\"row\">
        <div class=\"col-md-4\">
            <img src=\"/uploads/{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"w-100\">
        </div>
        <div class=\"col-md-8\">
            <h1>{{ product.name }}</h1>
            <p>{{ product.description }}</p>
            <hr>
            <p>Prix : {{ (product.price /100)|number_format(2 , ',', '.') }} MGA</p>
...
{% endblock %}
", "products/show.html.twig", "C:\\wamp64\\www\\projectS\\templates\\products\\show.html.twig");
    }
}
