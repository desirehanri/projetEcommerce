...
class __TwigTemplate_af851a127f96262c2ca37975ad961bab extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    <h1>My account</h1>
    Welcome to your account {{app.user.firstname}}
    <hr>
    
    - <a href =\"{{path('app_account_password')}}\">Change my password</a><br>
    - <a href=\"{{ path('app_account_address') }}\">Manage my location </a> <br>
    - Commandes <br>
    <hr>
{% endblock %}
", "account/index.html.twig", "C:\\wamp64\\www\\projectS\\templates\\account\\index.html.twig");
    }
}
